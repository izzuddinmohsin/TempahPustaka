              ...
              <div class="card card-dard">
                ...
                <div class="form-group text-center"><br>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <button type="button" class="btn btn-block btn-success btn-sm">{{ $booking->status }}</button>

                                @elseif ($booking->status == 'ditolak')
                                <button type="button" class="btn btn-block btn-danger btn-sm">{{ $booking->status }}</button>

                                @elseif ($booking->status == 'dibatalkan')
                                <button type="button" class="btn btn-block btn-danger btn-sm">{{ $booking->status }}</button>

                                @else
                                <button type="button" class="btn btn-block btn-dark btn-sm">{{ $booking->status }}</button>
                                @endif
                              </td>
                  ...
                  <div class="card-footer">
                    <a href="{{ route('bookings.index') }}"type="" class="btn bg-gradient-secondary">Kembali <i class="fa fa-home"></i></a>
                  </div>
                  </div>
                  <!-- /.card-body -->
