            ...
            <div class="col-lg-12">
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title">Kemaskini Status Tempahan Bilik/Ruang</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <form action="{{ route('booking.update', $booking->id) }}" method="POST">
                      ...
                      <select class="custom-select @error('status')  is-invalid @enderror" name="status">
                        @foreach (json_decode('{"dipohon":"dipohon", "ditolak":"ditolak", "diluluskan":"diluluskan"}') as $optionKey => $optionValue)
                        <option value="{{ $optionKey }}" {{ isset($booking->status) && ($booking->status == $optionKey) ? 'selected' : ''}}>{{ $optionValue }}</option>
                        @endforeach
                      </select> <hr>
