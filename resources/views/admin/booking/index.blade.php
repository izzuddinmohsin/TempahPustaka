                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <button type="button" class="btn btn-block btn-success btn-sm" disabled>{{ $item->status }}</button>

                            @elseif ($item->status == 'ditolak')
                            <button type="button" class="btn btn-block btn-danger btn-sm" disabled>{{ $item->status }}</button>

                            @else
                            <button type="button" class="btn btn-block btn-dark btn-sm" disabled>{{ $item->status }}</button>
                            @endif
                          </td>
                          ...
                          <td>
                            <div class="btn-group">
                              <form action="{{ route('booking.destroy',$item->id) }}" method="POST" class="btn-group">
                                @method('delete')
                                @csrf
                                <a href="{{ route('booking.show',$item->id) }}" class="btn btn btn-info"><i class="fa fa-eye"></i></a>
                                @if ($item->status == 'dipohon')
                                <a href="{{ route('booking.edit',$item->id) }}" class="btn btn btn-secondary"><i class="fa fa-edit"></i></a>                                    
                                @endif
