                    ...
                    <table id="example2" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              <form action="{{ route('room.destroy',$item->id) }}" method="POST" class="btn-group">
                                @method('delete')
                                @csrf
                                <a href="{{ route('room.show',$item->id) }}" class="btn btn btn-info"><i class="fa fa-eye"></i></a>
                                <a href="{{ route('room.edit',$item->id) }}" class="btn btn btn-secondary"><i class="fa fa-edit"></i></a>
