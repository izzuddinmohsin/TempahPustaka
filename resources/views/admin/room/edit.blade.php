            ...
            <div class="col-lg-12">
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title">Edit Bilik/Ruang</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-3">
                          ...
                          <select class="custom-select @error('location')  is-invalid @enderror" name="location">
                            ...
                            <option value="{{ $optionKey }}" {{ isset($room->location) && ($room->location == $optionKey) ? 'selected' : ''}}>{{ $optionValue }}</option>
                            @endforeach
                          </select>
                        ...
                        <div class="col-3">
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('capacity')  is-invalid @enderror" name="capacity" value="{{ $room->capacity }}" required>
                        </div>                     
                      </div>
                      </div>
                      <br>
                      <div class="row">
                        <div class="col-6">
                          ...
                          <input type="text" class="form-control @error('facility')  is-invalid @enderror" name="facility" value="{{ $room->facility }}" required>
                          <span class="small">*contoh : - 2 Unit PA sistem - 1 Unit Sofa</span>
                        </div>
                        <div class="col-6">
                          <label for="exampleInputEmail1">Tujuan/Kegunaan Bilik</label>
                          <input type="text" class="form-control @error('purpose')  is-invalid @enderror"  name="purpose" value="{{ $room->purpose }}" required>                      
                        </div>
                      </div> <br>
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Pratonton dokumen yang dimuat naik</label>
                        <div class="input-group-append">
                          <img class="img-fluid border" id="img-preview" height="200" width="200" src="{{ asset('image/room/'.$room->picture) }}">
                          <input type="hidden" name="old_picture" value="{{ $room->picture }}">
                        </div>
                      </div>
                    </div>
                  </div>
