              ...
              <div class="card card-primary">
                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                  ...
                  <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            <label>Peranan</label>
                            <select class="custom-select @error('role')  is-invalid @enderror" name="role" disabled>
                  ...
                  <div class="card-footer">
                    <a href="{{ route('users.index') }}"type="" class="btn bg-gradient-secondary">Kembali <i class="fa fa-home"></i></a>
                  </div>
                </form>
                  </div>
                  <!-- /.card-body -->
